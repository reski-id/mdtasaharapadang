...
?>
  ...
  <div class="row">
  <p></p>
  <h4 align="center"><b>NILAI PRAKTEK QUR'AN</b></h4>
  <div class="col-lg-3">
  <?php
 ...
 <?php
 $nomor=1;
  $myquery="SELECT tb_nilaiquran.kdkriteria, tb_nilaiquran.nilai FROM tb_siswa, tb_nilaiquran WHERE tb_siswa.NIS=tb_nilaiquran.NIS AND tb_nilaiquran.NIS=$txtcari";
  ...
  { ?>
      <tr>
        ...
        <td><?php
                  $sql = "SELECT * FROM tb_kriteria_penilaianquran WHERE kdpenilai = '$dataku[kdkriteria]'";
                  $result = mysqli_query($conn, $sql);
                  while($data=mysqli_fetch_array($result)){
                    echo "$data[kriteria]";
                  }

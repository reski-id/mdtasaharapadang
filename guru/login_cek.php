...
$cekuser = mysqli_query($conn, "SELECT * FROM tb_user WHERE username='$username' AND sandi='$password' AND tingkat='Guru'");
...
if($jmluser > 0){
   ...
   if($data['aktif']=="Tidak Aktif"){
      ...
      echo "<b>Silahkan hubungi Admin untuk mengaktifkan kembali Akun Anda</b>";
   } else{

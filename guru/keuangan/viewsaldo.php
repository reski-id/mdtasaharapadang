...
<html lang="en">
  ...
  <?php
        ...
        $sqlp = "SELECT SUM(jumlah) AS pengeluaran FROM tb_uangkeluar";
        $resultp = mysqli_query($conn, $sqlp);
        $dpengeluaran = mysqli_fetch_array($resultp);

      

        $sqlm = "SELECT SUM(jumlah) AS pemasukan FROM tb_uangmasuk";
...
?>
  ...
  <a name="" id="" class="btn btn-primary" href="uangmasuk/data_uangmasuk.php" role="button">Lihat Data</a>
  </div>
</div>
  </div>
  <div class="col-lg-6">
  ...
  <div class="panel-footer">
  <a name="" id="" class="btn btn-primary" href="uangkeluar/data_uangkeluar.php" role="button">Lihat Data</a>
  </div>
</div>
</div>
<div class="col-lg-12">

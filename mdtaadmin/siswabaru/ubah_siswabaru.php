  ...
  ?>
   <div class="container">
    <div class="row">
      ...
      <?php
      $cariid = mysqli_query($conn,"SELECT (MAX(NIS)+1) FROM tb_siswa");
      $idbaru = mysqli_fetch_array($cariid);
    ?>
     
        <form method="POST" action="perbarui_siswabaru.php">
          <div class="form-group">
            <div class="input-group col-md-5">
            <label>iDPendaftaran</label>
          ...
          <div class="form-group">
            <div class="input-group col-md-5">
            <label>BP</label>
            <input type="text" name="NIS" value="<?php echo $data2['NIS']; ?>" class="form-control" id="NIS"></input>
            </div>
            <p><i> <?php echo "BP tersedia : ". $idbaru[0];?></i></p>
          </div>
          <div class="form-group">
            <div class="input-group col-md-5">
          ...
          <div class="form-group">
            ...
            <input type="text" name="NoHpOrtu" class="form-control" id="NoHpOrtu" value="<?php echo $data2['NoHpOrtu']; ?>">
            </div>
          </div>

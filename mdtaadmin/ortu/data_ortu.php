...
<html lang="en">
  ...
  <div class="container">
  <div class="row">
  <legend>Manajemen Data Orang Tua</legend>
  <p><a href="tambah_dataortu.php"><button type="button" class="btn btn-danger">Tambah Data</button></a></p>
  ...
  <table class="table table-condensed table-bordered" id="table">
    ...
    ?>
        ...
        <a href="hapus_dataortu.php?idortu=<?php echo $data['idortu'];?>">
        <span class="glyphicon glyphicon-trash" aria-hidden="true" title="Hapus"></span>
        </a>
        </button>
        <button type="button" class="btn btn-success">
        <a href="smsortu.php?idortu=<?php echo $data['idortu'];?>">
        <span class="glyphicon glyphicon-envelope" aria-hidden="true" title="SMS"></span>
        </a>
        </button>
        </td>
      </tr>

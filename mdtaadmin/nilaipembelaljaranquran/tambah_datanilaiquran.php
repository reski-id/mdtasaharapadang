...
?>
   <div class="container">
    <div class="row">
      ...
      <div class="panel-heading">Tambah Nilai Baca Qur'an</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="simpan_datanilaiquran.php">
          ...
          <div class="form-group">
            ...
            <select name="kdpenilai" class="form-control" id="kdpenilai">
              <option value="" selected="selected">Kriteria Penilaian</option>
                <?php
          ...
          <a class="btn btn-warning" href="data_nilaiquran.php" role="button">Batal</a>

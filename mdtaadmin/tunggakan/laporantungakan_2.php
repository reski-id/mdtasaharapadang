...
?>
  ...
  <div class="row">
  <p></p>
  <h4 align="center"><b>Pencarian Tunggakan Siswa</b></h4>
  <div class="rows">&nbsp;</div>
  
  <!-- cari tunggakan/tahun,bulan,kategori -->
  <div class="col-lg-3">
    <form action="hasil_tunggakan.php" method="post" >
    <div class="input-group">
      <select name="tahun" class="form-control">
        <option value="">Pilih Tahun</option>
        <?php
          $sql = "SELECT tahun FROM vtb_tunggakan GROUP BY tahun";
  ...
  <!-- cari tunggakan/bulan,kategory,status -->
  <div class="col-lg-3">
    <form action="hasil_tunggakan2.php" method="post" >
    <div class="input-group">
    <select name="bulan" class="form-control">
          <option value="">Pilih Bulan</option>
          <option value="January">Januari</option>
      ...
      <select name="proses" class="form-control">
          <option value="">Pilih Status Tunggakan</option>
      ...
      <span class="input-group-btn">
        ...
        <button class="btn btn-success" type="submit" value="Cari">Temukan Tunggakan</button>
      </span>
    </div>
    </div>
    </div>

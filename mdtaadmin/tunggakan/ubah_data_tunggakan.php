  ...
  ?>
   <div class="container">
    <div class="row">
      ...
      <div class="panel-heading">Update Data Tunggakan</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="perbarui_data_tunggakan.php">
          ...
          <div class="form-group">
            ...
            <textarea name="kettungakan" class="form-control" required><?php echo $data1['kettungakan'] ?></textarea>
            </div>
          </div>

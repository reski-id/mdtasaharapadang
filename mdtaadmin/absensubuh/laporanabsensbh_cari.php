...
?>
  ...
  <div class="row">
  <p></p>
  <h4 align="center"><b>Pencarian Pelanggaran Absen Subuh Siswa</b></h4>
  <div class="col-lg-3">
  
  <form action="laporanabsensbh_hsl.php" method="post" >
  <div class="input-group">
    <select name="tahun" class="form-control">
      <option value="kosong">Pilih Tahun</option>
      <?php
        $sql = "SELECT Thn FROM vwabsen_subuh GROUP BY Thn";
        $result = mysqli_query($conn, $sql);
        while($tahun=mysqli_fetch_array($result)){
          echo "<option value=$tahun[Thn]>$tahun[Thn]</option>";
        }
      ?>
    </select>
    &nbsp;

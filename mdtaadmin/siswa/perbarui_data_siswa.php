...
<?php
	...
	$idorangtuas = htmlentities(trim($_POST['idorangtuas']));


	$sql = ("UPDATE tb_siswa SET NamaSiswa = '$NamaSiswa', JenisKelamin = '$JenisKelamin', 
		TempatLahir = '$TempatLahir', TanggalLahir = '$TanggalLahir', Agama = '$Agama', AlamatSiswa = '$AlamatSiswa', KodeKls = '$KodeKls', idklmpk = '$idklmpk', idorangtuas = '$idorangtuas' WHERE NIS = '$NIS'") 
		or die(mysql_error());

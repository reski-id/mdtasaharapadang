      ...
      <legend>Ubah Data</legend>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <option value="<?php echo $data2['tingkat']; ?>"><?php echo $data2['tingkat']; ?></option>
          ...
          <div class="form-group">
            ...
            <option value="<?php echo $data2['aktif']; ?>"><?php echo $data2['aktif']; ?></option>
            <option value="Aktif">Aktif</option>
            <option value="Tidak Aktif">Tidak Aktif</option>
            </select>
            </div>
          </div>
         <a name="" id="" class="btn btn-warning" href="data_user.php" role="button">Batal</a>

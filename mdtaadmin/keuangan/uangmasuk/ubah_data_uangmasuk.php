...
<html lang="en">
  ...
  ?>
    ...
    <div class="row">
      ...
      <div class="panel-heading">Update Data Uang Masuk</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="perbarui_data_uangmasuk.php">
          <div class="form-group">
            <div class="input-group col-md-5 hidden">
            <label>ID Uang Masuk</label>
          ...
          <a name="Batal" class="btn btn-warning" href="data_uangmasuk.php" role="button">Batal</a>

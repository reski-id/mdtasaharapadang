...
<?php
    ...
    $IDGURU = htmlentities($_GET['IDGURU']);
    $sql = "SELECT * FROM tb_guru WHERE IDGURU = '$IDGURU'";
  ...
  ?>
   <div class="container">
    <div class="row">
      ...
      <div class="panel-heading">Ubah Data Guru</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="perbarui_dataguru.php">
          <div class="form-group">
            <div class="input-group col-md-5">
            <label>ID</label>
            <input type="text" name="IDGURU" value="<?php echo $data2['IDGURU']; ?>" class="form-control" id="IDGURU" readonly></input>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group col-md-5">
          ...
          <a name="Batal" class="btn btn-warning" href="data_guru.php" role="button">Batal</a>

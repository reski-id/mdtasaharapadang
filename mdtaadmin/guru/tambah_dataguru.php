...
<html lang="en">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="panel-heading">Entri Data Guru</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="simpan_dataguru.php">
          <div class="form-group">
            <div class="input-group">
            <label>ID</label>
            <input type="text" name="IDGURU" class="form-control" id="IDGURU" required></input>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">

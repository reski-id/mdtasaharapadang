...
<html lang="en">
  ...
  ?>
    ...
    <div class="row">
      ...
      <div class="panel-heading">Entri Data Pelanggaran</div>
       <div class="panel-body">
        <div class="container">
        <form method="POST" action="simpan_data_pelanggaran.php">
          ...
          <div class="form-group">
            ...
            <option value="" selected="selected">Jenis Pelanggaran</option>

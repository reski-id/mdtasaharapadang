...
?>
  ...
  ?>
    ...
    {     
      ...
      $myquery="select * from tb_siswa join klmpsubuh on tb_siswa.idklmpk=klmpsubuh.idklmpk where klmpsubuh.idklmpk=".$_POST['idklmpk']." AND tb_siswa.idorangtuas=$idortu";
    }
    else
    {
